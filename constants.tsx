...
export const SAMPLE_RESUME: ResumeData = {
  ...
  phone: "555-0199",
  summary: "Motivated software engineer with 2 years of experience in React and Node.js. Passionate about building scalable web applications and solving complex problems.",
  ...
  skills: [
    { id: "1", name: "JavaScript", level: "Intermediate", category: "Technical" },
    { id: "2", name: "React", level: "Intermediate", category: "Technical" },
    { id: "3", name: "CSS", level: "Expert", category: "Technical" },
  ...
  projects: [
    {
        ...
        description: "Built a dashboard for tracking sales and inventory.",
